$(window).load(function() {
    ...
    //muted = $('#muted');
    //close = $('#close');
    song1 = new Audio('music/track1.ogg','http://danielrevelry.com/wp-content/uploads/2015/12/Bright-Lights-2.m4a');
    song2 = new Audio('music/track1.ogg','http://danielrevelry.com/wp-content/uploads/2015/12/Pride-and-Joy-1.m4a');
    duration = song1.duration;

    if (song1.canPlayType('audio/mpeg;')) {
        song1.type= 'audio/mpeg';
        song1.src= 'http://danielrevelry.com/wp-content/uploads/2015/12/Bright-Lights-2.m4a';
    } else {
    ...
    if (song2.canPlayType('audio/mpeg;')) {
        ...
        song2.src= 'http://danielrevelry.com/wp-content/uploads/2015/12/Pride-and-Joy-1.m4a';
    } else {
